...
RARITIES = {
    "common":    ("⚪", "Обычный",     50.0, 2),
    "uncommon":  ("🟢", "Необычный",   28.0, 4),
    "rare":      ("🔵", "Редкий",      14.0, 7),
    "epic":      ("🟣", "Эпический",    2.2, 11),
    "legendary": ("🟠", "Легендарный",  0.5, 16),
    "mythic":    ("🔴", "Мифический",   0.12, 24),
    "relic":     ("🌟", "Реликтовый",   0.02, 36),
}
...
DUNGEONS = {
    "rats": {
        "emoji": "🕸️", "name": "Крысиные норы", "min_level": 1,
    ...
    "fort": {
        "emoji": "🏰", "name": "Забытая крепость", "min_level": 6,
    ...
    "dragon": {
        "emoji": "🌋", "name": "Логово дракона", "min_level": 14,
